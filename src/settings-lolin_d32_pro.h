...
#define __ESPUINO_SETTINGS_LOLIN_D32_PRO_H__
    ...
    */
    ...
    #define BUTTON_4                        15          // Button 4: GPIO to detect volume up with (10k-pullup-resistor)
    #define BUTTON_5                         0          // Button 5: GPIO to detect volume down (with 10k-pullup-resistor)
