    ...
    <div class=\"container my-5\" id=\"mqttConfig\">\
        ...
        <form class=\"needs-validation\" action=\"#mqttConfig\" method=\"POST\" onsubmit=\"mqttSettings('mqttConfig'); return false\">\
            ...
            <div class=\"form-group my-2 col-md-6\">\
                ...
                <input type=\"text\" class=\"form-control\" id=\"mqttUser\" maxlength=\"32\" placeholder=\"Benutzername\" name=\"mqttUser\" value=\"%MQTT_USER%\" required>\
                <label for=\"mqttPwd\">Passwort:</label>\
                <input type=\"password\" class=\"form-control\" id=\"mqttPwd\" maxlength=\"32\" placeholder=\"Passwort\" name=\"mqttPwd\" value=\"%MQTT_PWD%\" required>\
     \
            </div>\
          <button type=\"reset\" class=\"btn btn-secondary\">Reset</button>\
          <button type=\"submit\" class=\"btn btn-primary\">Absenden</button>\
